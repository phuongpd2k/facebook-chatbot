...
public enum EventType {
	...
	PRESENCE_CHANGE, MANUAL_PRESENCE_CHANGE, PREF_CHANGE, USER_CHANGE, TEAM_JOIN, STAR_ADDED, STAR_REMOVED,
	REACTION_ADDED, REACTION_REMOVED, EMOJI_CHANGED, COMMANDS_CHANGED, TEAM_PLAN_CHANGE, TEAM_PREF_CHANGE, TEAM_RENAME,
	TEAM_DOMAIN_CHANGE, EMAIL_DOMAIN_CHANGED, TEAM_PROFILE_CHANGE, TEAM_PROFILE_DELETE, TEAM_PROFILE_REORDER, BOT_ADDED,
	BOT_CHANGED, ACCOUNTS_CHANGED, TEAM_MIGRATION_STARTED, RECONNECT_URL, SUBTEAM_CREATED, SUBTEAM_UPDATED,
	SUBTEAM_SELF_ADDED, SUBTEAM_SELF_REMOVED, ACK, SUBSCRIBE, MESSAGE_DELIVERED, MESSAGE_READ, MESSAGE_ECHO, POSTBACK,
	OPT_IN, REFERRAL, PAYMENT, CHECKOUT_UPDATE, PRE_CHECKOUT, ACCOUNT_LINKING, QUICK_REPLY, MEMBER_JOINED_CHANNEL,
	MEMBER_LEFT_CHANNEL
}
